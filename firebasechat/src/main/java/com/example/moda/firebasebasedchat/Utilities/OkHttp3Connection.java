...
public class OkHttp3Connection {
    ...
    public static void doOkHttp3Connection(String auth,String langid, String request_Url, Request_type request_type,
                                           JSONObject requestBody, OkHttp3RequestCallback callbacks, String token) {
        OkHttpRequestData data = new OkHttpRequestData();
        data.request_Url = request_Url;
        data.requestBody = requestBody;
    ...
    public static void doOkHttp3Connection(String auth, String langid, String request_Url, Request_type request_type, JSONObject requestBody, OkHttp3RequestCallback callbacks) {
        OkHttpRequestData data = new OkHttpRequestData();
        data.request_Url = request_Url;
        data.requestBody = requestBody;
        data.callbacks = callbacks;
    ...
    private static class OkHttpRequestData {
        public String request_Url, token, auth = "",langid;
            ...
            try {
                ...
                if (params[0].request_type.equals(Request_type.URl)) {
                    ...
                    request = new Request.Builder()
                            ...
                            .header("lang",  VariableConstant.LANGUAGE)
                            .build();
