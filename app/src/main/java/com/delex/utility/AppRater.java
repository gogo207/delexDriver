...
/**
 * Created by muthu on 4/3/2018.
 */

public class AppRater {
        private final static String APP_TITLE = "Truckr Driver";// App Name
    private final static String APP_PNAME = "com.truckr.driver";// Package Name
    ...
    /*    final Dialog dialog = new Dialog(mContext);
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.rate_dialog_layout, null);
