...
public class SessionManager {
    ...
    private final String VAT_AMOUNT="vatAmount";

    private final String BANK_NUMBER="bankNumber";
    private final  String BANK_NAME="bankName";
    private final String HOLDER_NAME="holderName";
    private final String IBAN_NO="ibanNo";
    private final String  SWIFT_CODE="swiftCode";
    private final  String ROUTING_NO="routingNo";
    private  final String BANKD="bankd";
    /***********************************************************************************************/
    ...
    public String getSessionToken() {
        return sharedPreferences.getString(SESSION_TOKEN, "ordinory");
    }
    ...
    public  String getBankNumber(){
        return sharedPreferences.getString(BANK_NUMBER,"");

    }

    public void setBankNumber(String bankNumber){
        editor.putString(BANK_NUMBER,bankNumber);
        editor.commit();
    ...
    public void setHolderName(String holderName){
        editor.putString(HOLDER_NAME,holderName);
        editor.commit();
    ...
    public  String getRoutingNo(){
        return sharedPreferences.getString(ROUTING_NO,"");

    }

    public void setRoutingNo(String routingNo){
        editor.putString(ROUTING_NO,routingNo);
        editor.commit();
    ...
    public  String getIBAN(){
        return sharedPreferences.getString(IBAN_NO,"");

    }

    public void setIBAN(String iban){
        editor.putString(IBAN_NO,iban);
        editor.commit();

    }

    public  String getSwift(){
        return sharedPreferences.getString(SWIFT_CODE,"");

    }

    public void setSwift(String swift){
        editor.putString(SWIFT_CODE,swift);
        editor.commit();
    ...
    public  String getVAT_AMOUNT(){
        return sharedPreferences.getString(VAT_AMOUNT,"$0.00");

    }

    public void setVAT_AMOUNT(String s){

        editor.putString(VAT_AMOUNT,s);
        editor.commit();
    }
...
*/
    ...
    public void setLangName(String language)
    {
    ...
    {
        return sharedPreferences.getString("language_name", "English");
    }


    public boolean getBANKD() {
        return sharedPreferences.getBoolean(BANKD, false);
    }

    public void setBANKD(boolean publishKey) {
        editor.putBoolean(BANKD, publishKey);
        editor.commit();
    }
